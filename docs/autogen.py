...
wrangle_dir = pathlib.Path(__file__).resolve().parents[1]
...
def generate(markdown_dir):
    """Generates the markdown files for the documentation.

    # Arguments
        markdown_dir: Where to put the markdown files.
    """
    # template_dir = os.path.join(str(wrangle_dir), 'docs', 'templates')
    ...
    print('Populating markdown directory with templates.')
    # shutil.copytree(template_dir, markdown_dir)

    # readme = read_file(os.path.join(str(wrangle_dir), 'README.md'))
    # index = read_file(os.path.join(template_dir, 'index.md'))
    # index = index.replace('{{autogenerated}}', readme[readme.find('##'):])
    # with open(os.path.join(markdown_dir, 'index.md'), 'w') as f:
        # f.write(index)
    ...
    for page_data in PAGES:
        ...
        path = os.path.join(markdown_dir, page_name)
    ...
    # shutil.copyfile(os.path.join(str(wrangle_dir), 'README.md'),
    #                 os.path.join(str(markdown_dir), 'index.md'))
    # copy_examples(os.path.join(str(wrangle_dir), 'examples'),
                  # os.path.join(str(markdown_dir), 'examples'))


if __name__ == '__main__':
    generate(os.path.join(str(wrangle_dir), 'docs', 'markdown'))
